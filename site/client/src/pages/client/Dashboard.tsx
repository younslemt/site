  ...
  return (
    <div className="space-y-8">
      <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6 sm:p-8">
        <h1 className="text-2xl font-bold text-gray-900 mb-2">Bienvenue dans Sprint Master votre espace de gestion des Sprint !</h1>
        {organizationName && (
          <p className="text-lg text-indigo-600 font-semibold mb-2">{organizationName}</p>
        )}
        <p className="text-gray-500">Transformez vos contraintes en opportunités : <a href="https://www.MasterYourMetrics.be" target="_blank" rel="noopener noreferrer" className="text-indigo-600 hover:underline">www.MasterYourMetrics.be</a></p>
      </div>
